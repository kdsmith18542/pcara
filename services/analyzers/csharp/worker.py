...
class CSharpAnalysisWorker:
    ...
    def run(self):
        """Main worker loop"""
        logger.info("C# analyzer worker starting...")
    ...
    def process_job(self, job_info):
        ...
        if "csharp" not in languages and "c#" not in languages:
            logger.info(f"Job {job_id} does not require C# analysis, skipping")
            return
